...
import type { ApprovalRequest } from '../src/presentation/index.js'

function buildRequest(method: string, params: unknown, overrides: Partial<ApprovalRequest> = {}): ApprovalRequest {
  return { method, params, ...overrides }
}
